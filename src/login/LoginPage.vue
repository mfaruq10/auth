<template>
    <div>
        <p class="card-header h4 text-center mb-4">Login</p>
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                <button class="btn btn-lg btn-primary btn-block text-uppercase" :disabled="status.loggingIn">Login</button>
                ...
                <router-link to="/register" class="btn btn-link">Daftar Disini</router-link>
            </div>
        </form>
    </div>
</template>
